...
const exclaimThree = str => {return str.toUpperCase () + '!!!' }
 ...
 console.log(exclaimThree('my name is danish'))
...
namesGreeting = console.log(nameCheck('Danish'))
...
let colorRating = console.log(faveColorFinder('blue'))
...
let oddChecker = console.log(thatsOdd(5))
...
const theBestMovie = console.log(bestMovie('Inception'))
...
contestants.splice(i, 1);
 ...
 newcontestants = console.log (theEliminator(contestants, loser))
